      ...
      <div class="row">
        <div class="col-md-12 text-center">
          <div class="block wow fadeInUp" data-wow-delay=".3s">
            ...
            <a class="btn-lines dark light wow fadeInUp animated smooth-scroll btn btn-default btn-green" data-wow-delay=".9s" href="#works" data-section="#works" style="background:#f44336" onclick="document.getElementById('id01').style.display='block'">Join Us !</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-3 col-sm-4 col-xs-12">
          <figure class="wow fadeInLeft animated portfolio-item" data-wow-duration="500ms" data-wow-delay="300ms">
            <div class="img-wrapper" style="box-shadow: 0px 10px 12px grey;">
              <img src="images\categories\actionandadventure.jpg" class="img-responsive" alt="this is a title" style="width : 450px ; height :185px; " />
        ...
        <div class=" col-md-3 col-sm-4 col-xs-12">
          <figure class="wow fadeInLeft animated" data-wow-duration="500ms" data-wow-delay="300ms">
            <div class="img-wrapper" style="box-shadow: 0px 10px 12px grey;">
              <img src="images\categories\mysteryandthriller.jpg" class="img-responsive" alt="" style="width : 450px ; height :185px;" />
              <a target="_blank" href="browse.php">
                <div class="overlay">
        ...
        <div class="col-md-3 col-sm-4 col-xs-12">
          <figure class="wow fadeInLeft animated portfolio-item" data-wow-duration="500ms" data-wow-delay="600ms">
            <div class="img-wrapper" style="box-shadow: 0px 10px 12px grey;">
              <img src="images\categories\biosandhistory.jpg" class="img-responsive" alt="this is a title" style="width : 450px ; height :185px;" />
              <a target="_blank" href="browse.php">
                <div class="overlay">
        ...
        <div class="col-md-3 col-sm-4 col-xs-12">
          <figure class="wow fadeInLeft animated portfolio-item" data-wow-duration="500ms" data-wow-delay="900ms">
            <div class="img-wrapper" style="box-shadow: 0px 10px 12px grey;">
              <img src="images\categories\nonfiction.jpg" class="img-responsive" alt="this is a title" style="width : 450px ; height :185px;" />
              <a target="_blank" href="browse.php">
                <div class="overlay">
      ...
      <div class="row">
        ...
        <div class="col-md-3">
          <div class="team-member wow fadeInLeft" data-wow-duration="500ms" data-wow-delay=".3s">
            <div class="team-img">
              <img style="height:350px;" src="images/team/bob.jpg" class="team-pic" alt="">
            </div>
            <h3 class="team_name">Bob</h3>
        ...
        <div class="col-md-3">
          <div class="team-member wow fadeInLeft" data-wow-duration="500ms" data-wow-delay=".5s">
            <div class="team-img">
              <img style="height:350px;" src="images/team/lela.jpg" class="team-pic" alt="">
            </div>
            <h3 class="team_name">Lela</h3>
            <p class="team_designation">CEO, Project Manager</p>
            <p class="team_text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
              incididunt ut labore et dolore .</p>
            <p class="social-icons">
        ...
        <div class="col-md-3">
          <div class="team-member wow fadeInLeft" data-wow-duration="500ms" data-wow-delay=".7s">
            <div class="team-img">
              <img style="height:350px;" src="images/team/leo.jpg" class="team-pic" alt="">
            </div>
            <h3 class="team_name">Leo</h3>
            <p class="team_designation">CEO, Project Manager</p>
            <p class="team_text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
              incididunt ut labore et dolore .</p>
            <p class="social-icons">
        ...
        <div class="col-md-3">
          <div class="team-member wow fadeInLeft" data-wow-duration="500ms" data-wow-delay=".9s">
            <div class="team-img">
              <img style="height:350px;" src="images/team/toni.jpg" class="team-pic" alt="">
            </div>
            <h3 class="team_name">Toni</h3>
            <p class="team_designation">CEO, Project Manager</p>
            <p class="team_text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
              incididunt ut labore et dolore .</p>
            <p class="social-icons">
